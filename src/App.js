  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/:id/admin/categories" element={ <DndProvider backend={HTML5Backend}><Categories translaterFun={t} /></DndProvider>}></Route>
        <Route path="/:id/admin/categories/reorder/" element={ <DndProvider backend={HTML5Backend}><DndCategories translaterFun={t} /></DndProvider>}></Route>
